    ...
    public class RefreshTokenService : IRefreshTokenService
    {
        ...
        public JwtSecurityToken GenerateRefreshToken(UserLoginRequest user)
        {
            ...
            var key = new SymmetricSecurityKey(
                Encoding.UTF8.GetBytes(_configuration.GetSection("AppTokenSettings:RefreshToken").Value));
        ...
        public bool IsValidRefreshToken(string token)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration.GetSection("AppTokenSettings:RefreshToken").Value));
